...
$iconPath = Join-Path -Path $scriptDirectory -ChildPath "FilesInstall\icono.ico"
$shortcutPath = "$env:USERPROFILE\Desktop\Arepaland Launcher.lnk"
$scriptPath = Join-Path -Path $env:USERPROFILE\Documents -ChildPath "ActualizadorGit.ps1"  # Ruta del script ActualizadorGit.ps1

# Código para crear el script ActualizadorGit.ps1
@"
