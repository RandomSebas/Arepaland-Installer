...
$scripts = @("InstaladorJava.ps1", "InstaladorSK.ps1", "InstaladorChocolatey.ps1", "InstaladorGithub.ps1", "ClonarRepo.ps1" "MoverCarpetaArepaland.ps1", "ActualizacionJSON.ps1", "AccesoDirectoCreacion.ps1") # Agrega aquí los nombres de tus scripts
